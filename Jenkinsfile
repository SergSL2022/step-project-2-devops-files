        ...
        stage('Build Docker image') {
            steps {
                ...
                sh """
                    ...
                    docker images
                    cd ~/jenkins/workspace/step-project-2
                    if [ ! -d "artifacts" ]; then
                        mkdir artifacts
                    fi
                    docker save -o /home/vagrant/jenkins/workspace/step-project-2/artifacts/danit_v.0.0.${BUILD_NUMBER}.tar serhiyslipchuk/danit:v.0.0.${BUILD_NUMBER}
                    """
            }
        }
